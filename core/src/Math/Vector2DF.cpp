...
bool Vector2DF::operator==(const Vector2DF& right) { return X == right.X && Y == right.Y; }
...
Vector2DF Vector2DF::operator+(const Vector2DF& right) const { return Vector2DF(X + right.X, Y + right.Y); }
...
Vector2DF Vector2DF::operator*(float right) const { return Vector2DF(X * right, Y * right); }
